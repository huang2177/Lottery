...
import com.huangbryant.weather.weather.adapter.ImageWeatherAdapter;
import com.huangbryant.weather.weather.adapter.OnItemClickListener;
import com.huangbryant.weather.weather.application.LoadMoreListener;
...
import com.huangbryant.weather.weather.utils.FileUtils;
...
//                imageWeather.setCity(city);
//                imageWeather.setLocation(mLocation);
//                imageWeather.setSay(aMapLocation.getAddress());
//                imageWeather.setImageUrl("");
//                Random random=new Random();
//                imageWeather.setPraise((long)random.nextInt(50));
